from .std import WassersteinLossWeighted, VectorialL1LossWeighted, StdLossWeighted, StructuralSimilarity3DLoss, FluenceTopKLogNCCLoss
...
import torch
from .gradients import SobelLoss, GradientL1Loss
...
class HistogramLoss(Loss):
    ...
    def __init__(self, bin_dim: int = -1, weight_with_error: bool = False, penalize_out_of_range: bool = False, calc_moments: bool = False):
        ...
        self.l1_loss = VectorialL1LossWeighted(bin_dim, weight_with_error, reduction='mean')
