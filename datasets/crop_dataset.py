from rftypes import RadiationFieldChannel, RadiationField, TrainingInputData, DirectionalInput, rf3TrainingInputData, rf3RadiationField
...
class CropDataset(DataProcessing):
    ...
    def crop_channel(self, field: RadiationFieldChannel) -> RadiationFieldChannel:
        ...
        cropped_fluence = self.crop_tensor(field.flux)
    ...
    def crop_radiation_field(self, field: RadiationField) -> RadiationField:
        ...
        """
        xray_beam_cropped = self.crop_channel(field.direct_beam) if field.direct_beam is not None else None
