...
class ChannelsJoin(DataProcessing):
    def join_channels(self, field: RadiationField) -> RadiationFieldChannel:
        ...
        total_fluence = field.scatter_field.flux + field.direct_beam.flux
        scatter_fluence = field.scatter_field.flux
        beam_fluence = field.direct_beam.flux
        ...
        if not valid_mask.all():
            ...
            beam_fluence = field.direct_beam.flux[valid_mask]
        if len(total_fluence.shape) < len(field.direct_beam.spectrum.shape):
